@extends('messenger.partials.app')
@section('content')
    <section class="wsus__chat_app">

        @include('messenger.partials.user-list-sidebar')
        ...
        <div class="wsus__chat_area">
            ...
            <div class="wsus__chat_area_body">
                ...
                {{-- <div class="wsus__single_chat_area">
                    <div class="wsus__single_chat chat_right">
                        ...
                        <a class="venobox" data-gall="gallery01" href="images/chat_img.png">
                            <img src="{{ 'assets/images/chat_img.png' }}" alt="gallery1" class="img-fluid w-100">
                        </a>
                        <span class="time"> 5h ago</span>
                        <a class="action" href="#"><i class="fas fa-trash"></i></a>
                    </div>
            ...
            <div class="wsus__chat_area_footer">
                <div class="footer_message">
                    ...
                    <form action="#" class="message-form" id="message-form" enctype="multipart/form-data">
                        <div class="file">
        ...
        @include('messenger.partials.user-info-sidebar')
